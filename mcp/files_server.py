...
All operations are confined to SANDBOX_DIR (default: /tmp/picoclcaw-sandbox).
...
SANDBOX_DIR = Path(os.environ.get("SANDBOX_DIR", "/tmp/picoclcaw-sandbox")).resolve()
...
if __name__ == "__main__":
    run_server("picoclcaw-files", "1.0.0", TOOLS, handle_call)
