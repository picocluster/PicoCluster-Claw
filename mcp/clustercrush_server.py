#!/usr/bin/env python3
"""Picocrush Control MCP Server — manage Ollama models and GPU on clustercrush."""
...
TOOLS = [
    {
        ...
        "description": "List all LLM models installed on clustercrush (the Jetson Orin Nano). Shows name, size, and parameter count.",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "get_active_models",
        "description": "Get models currently loaded in GPU memory on clustercrush. Shows which model is warm and ready.",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "get_gpu_memory",
        "description": "Get NVIDIA GPU memory usage on clustercrush (Jetson Orin Nano).",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
        "name": "pull_ollama_model",
        "description": "Download a new model to clustercrush from the Ollama library. Example model names: gemma3:1b, qwen2.5-coder:7b, mistral:7b",
        "inputSchema": {
            "type": "object",
            "properties": {
...
def handle_call(name, args):
    if name == "list_ollama_models":
        ...
        return f"Installed models on clustercrush:\n" + "\n".join(lines)
        ...
        return f"Active models on clustercrush:\n" + "\n".join(lines)
        ...
        return f"Pulling {model} on clustercrush...\n" + _http_post(
...
if __name__ == "__main__":
    run_server("clusterclaw-clustercrush", "1.0.0", TOOLS, handle_call)
