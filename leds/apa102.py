...
class Blinkt:
    ...
    def _init_v1(self, chip_path):
        ...
        self._data_line.request(consumer="picoclcaw-leds", type=gpiod.LINE_REQ_DIR_OUT, default_val=0)
        self._clock_line.request(consumer="picoclcaw-leds", type=gpiod.LINE_REQ_DIR_OUT, default_val=0)
